...
```syntax
CREATE TABLE User_Detail (User_ID int PRIMARY KEY AUTO_INCREMENT,UserName varchar(30) NOT NULL,Email varchar(100) UNIQUE NOT NULL,Phone_NO int UNIQUE NOT NULL,Password varchar(20) UNIQUE NOT NULL);
```
...
```syntax
CREATE TABLE Roles (Role_ID int PRIMARY KEY AUTO_INCREMENT,User_ID int, Role_Name varchar(50) NOT NULL,FOREIGN KEY(User_ID) REFERENCES User_Detail(User_ID));
```
...
```syntax
CREATE TABLE Add_Category (Category_ID int PRIMARY KEY AUTO_INCREMENT,User_ID int,Category_Name varchar(100) UNIQUE NOT NULL,FOREIGN KEY(User_ID) REFERENCES User_Detail(User_ID));
```
...
```syntax
CREATE TABLE Add_Product (Product_ID int PRIMARY KEY AUTO_INCREMENT,Category_ID int,Product_Name varchar(100) NOT NULL,Cost_Detail_inRupees varchar(100),Product_Detail varchar(300),FOREIGN KEY(Category_ID) REFERENCES Add_Category(Category_ID));
```
...
```syntax
CREATE TABLE Shopping (Shop_ID int PRIMARY KEY AUTO_INCREMENT,User_ID int,Product_ID int,Category_ID int,No_Of_Products int, FOREIGN KEY(User_ID) REFERENCES User_Detail(User_ID),FOREIGN KEY(Product_ID) REFERENCE Add_Product(Product_ID),FOREIGN KEY(Category_ID) REFERENCES Add_Category(Category_ID));
```
...
```syntax
CREATE TABLE Shop_Payment (Payment_ID int PRIMARY KEY AUTO_INCREMENT,Shop_ID int NOT NULL,CardHolder_Name varchar(20) NOT NULL,Account_NO bigint NOT NULL,Total_Amount_inRupees varchar(100) NOT NULL,Transaction_Date DATE NOT NULL,FOREIGN KEY(Shop_ID) REFERENCES Shopping(Shop_ID));
```
...
```syntax
 CREATE TABLE Reviews (Review_ID int PRIMARY KEY AUTO_INCREMENT,User_ID int,Name varchar(30) NOT NULL,Date DATE NOT NULL,Stars tinyint NOT NULL,Feedback varchar(100),FOREIGN KEY (User_ID) REFERENCES User_Detail (User_ID));
 ```
...
```syntax
CREATE TABLE Ticket_Booking (Ticket_ID int PRIMARY KEY AUTO_INCREMENT,User_ID int,Email varchar(300) NOT NULL,Phone_NO bigint NOT NULL,Date_Of_Journey DATE NOT NULL,No_Of_Passengers int NOT NULL,FOREIGN KEY(User_ID) REFERENCES User_Detail(User_ID));
```
###### Query OK, 0 rows affected (0.06 sec)
